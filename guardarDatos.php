...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    try{
        $sentencia = "INSERT INTO tareas(titulo, fecha_asig, fecah_venc, id_asignador, id_user_asignado, decripcion, fecha_creacion, estatus) VALUES (:titulo, :fecha_inicio, :fecha_fin, :current_id,
        :asignado, :descripcion, :fecha_creacion, :estatus)";
